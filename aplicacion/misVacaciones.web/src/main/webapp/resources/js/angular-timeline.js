(function(ng){
var mod = ng.module('angular-timeline', []);// Source: src/timeline-badge-directive.js
/**
 * @ngdoc directive
 ...
 */
mod.directive('timelineBadge', function() {
  return {
 ...
 */
mod.directive('timeline', function() {
  return {
    restrict: 'AE',
    transclude: true,
...
mod.directive('timelineEvent', function() {
  return {
    require: '^timeline',
    restrict: 'AE',
    transclude: true,
 ...
 */
mod.directive('timelineFooter', function() {
  return {
 ...
 */
mod.directive('timelineHeading', function() {
  return {
    require: '^timelinePanel',
    restrict: 'AE',
    transclude: true,
 ...
 */
mod.directive('timelinePanel', function() {
  return {
    require: '^timeline',
    restrict: 'AE',
    transclude: true,
